...
public class TelaVenda implements ActionListener{
	...
	private Venda conteudoTela() {
		...
		// verifica qual check foi escolhi para opção de pagamento e seta na forma de pagamento as opções selecionadas
		if (chckbxCartoCrdito.isSelected() && chckbxCartoDbito.isSelected() && chckbxDinheiro.isSelected()) {
			v.setFormaPagamento(chckbxCartoCrdito.getText() + " / " + chckbxCartoDbito.getText() + " / " + chckbxDinheiro.getText());
